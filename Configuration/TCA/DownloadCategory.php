...
$TCA['tx_downloads_domain_model_downloadcategory'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, starttime, endtime, fe_group, name, file_name_part',
	),
	'types' => array(
		'1' => array(
      'showitem' => 
		    'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, file_name_part,
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_downloads_domain_model_downloadcategory.pid=###CURRENT_PID### AND tx_downloads_domain_model_downloadcategory.sys_language_uid IN (-1,0)',
			),
		),
      ...
      'config' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:downloads/Resources/Private/Language/locallang_db.xml:tx_downloads_domain_model_downloadcategory.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
		...
		'file_name_part' => array(
      'exclude' => 0,
      'label' => 'LLL:EXT:downloads/Resources/Private/Language/locallang_db.xml:tx_downloads_domain_model_downloadcategory.file_name_part',
      'config' => array(
        'type' => 'input',
        'size' => 30,
        'eval' => 'trim'
