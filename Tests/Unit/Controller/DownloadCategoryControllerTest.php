...
/**
 * Test case for class Tx_Downloads_Controller_DownloadCategoryController.
 *
 * @version $Id$
 ...
 */
class Tx_Downloads_Controller_DownloadCategoryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
