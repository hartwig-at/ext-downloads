<?php
class Tx_Downloads_Controller_StatsController extends Tx_Extbase_MVC_Controller_ActionController  {private $implementation;private function getImplementation() {  if( null == $this->implementation ) {    $this->implementation = new DownloadsStatsControllerImplementation($this);  }  return $this->implementation;}function __construct() {parent::__construct();}
/**
* downloadRepository
...
/**
*/
public function showAction() { return $this->getImplementation()->showAction(); }
/**
*/
public function graphByDateAction() { return $this->getImplementation()->graphByDateAction(); }
/**
*/
public function graphByCountAction() { return $this->getImplementation()->graphByCountAction(); }
/**
*/
public function graphByReferrerAction() { return $this->getImplementation()->graphByReferrerAction(); }
}require_once('DownloadsStatsControllerImplementation.php');
?>