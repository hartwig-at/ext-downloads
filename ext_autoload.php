<?php
$extensionClassesPath = t3lib_extMgm::extPath( "downloads" ) . "Classes/";
return array(
  
  "tx_downloads_utility_filename" => $extensionClassesPath . "Utility/Filename.php"

  /*
	'tx_news_domain_model_dto_emconfiguration' => $extensionClassesPath . 'Domain/Model/Dto/EmConfiguration.php',
  "tx_downloads_hooks_suggestreceiver" => $extensionClassesPath . "Hooks/SuggestReceiver.php",
